...
class SimplyLinkedList:
    ...
    #Operacion para eliminar un elemento al inicio de la lista
    def DeleteFirst(self):
        ...
        #VAlidar si queda un solo elemento en la lista
            ...
            self.size -=1
        #Operacion eliminar un elemento al inicio de la lista
        else:
            self.first = self.first._next
           #Actualizar el tamaño de la lista
            self.size -=1 

    #Operacion para eliminar el ultimo elemento de la lista
    def DeleteLast(self):
        #Valirdar si la lista esta vaci
        if self.Empty():
            print("Error No es posible eliminar un elemento de una lista vacia")
        #VAlidar si queda un solo elemento en la lista
        elif self.first ==self.last:
            ...
            #Actualizar el tamaño de la lista
            self.size -=1
        #Operacion eliminar un elemento al Final de la lista
        else: 
            aux = self.first
    ...
    #Operacion para Buscar data en la lista
