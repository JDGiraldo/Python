...
class Queue:
    ...
    def __init__(self):
        ...
        self.rear = None #Elemento final 
        self.size = 0 #Tamano

    #Operacion si la lista esta vacia
    def Empty(self):
        return self.front == None
    
     #Operacion para aInsertar un elemento en la cola
    ...
    #Operacion para eliminar el primer elemetno de la cola
    def Dequeue(self):
        ...
        # Operación eliminar un elemento al inicio de la cola
            ...
            # Actualizar el tamaño de la cola
            self.size -= 1
    #Operacion para Mostrar el elemento FRONT de la cola
    def Front(self):
        return self.front

    #Operacion para Mostar los elementos de la cola
    def Show(self):
        aux = self.front
        while aux:
            print(aux, end= " ")
...
#Crar una cola con dos campos en el nodo
class Queue2:
    #COnstructor
    def __init__(self):
        self.front = None #Elemento Frontal de la cola
